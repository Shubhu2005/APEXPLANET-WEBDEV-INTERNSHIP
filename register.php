    ...
    <div class="container">
        ...
        <form id="registerForm" action="register.php" method="post">
            ...
            <div class="form-group">
                <input type="text" name="username" placeholder="Username" value="<?php echo htmlspecialchars($_POST['username'] ?? '', ENT_QUOTES); ?>" required>
            </div>
            ...
            <div class="form-group">
                <input type="tel" name="phone" placeholder="Phone Number (10 digits)" pattern="[0-9]{10}" value="<?php echo htmlspecialchars($_POST['phone'] ?? '', ENT_QUOTES); ?>" required>
            </div>

            <div class="form-group">
                <input type="date" name="dob" value="<?php echo htmlspecialchars($_POST['dob'] ?? '', ENT_QUOTES); ?>" required>
            </div>

            <div class="form-group">
                <input type="text" name="address" placeholder="Address" value="<?php echo htmlspecialchars($_POST['address'] ?? '', ENT_QUOTES); ?>" required>
            </div>
